...
public class MediaTransmit
{
	...
	public MediaTransmit(MediaLocator locator, String ipAddress, String pb,
			Format format,TextArea ta)
	{
		...
		for (int i = 0; i < tracks.length; i++)
		{
			...
			if (tracks[i].isEnabled())
			{
				...
				if (supported.length > 0)
				{
					...
					ta.append("  < Track " + i + " is set to transmit as:\n");
	...
	void setJPEGQuality(Player p, float val)
	{
		...
		for (int i = 0; i < cs.length; i++)
		{
			...
			if (cs[i] instanceof QualityControl && cs[i] instanceof Owned)
			{
				...
				if (owner instanceof Codec)         //Codec ÊÇÒ»¸ö±àÂëÆ÷
				{
